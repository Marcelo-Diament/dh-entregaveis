    ...
    <main class="container">
        <section class="row">
            <article class="enunciado col-12">
                ...
                <p>Definir uma função chamada <strike>elevarAoSegundo​</strike> elevarAoQuadrado que receba dois números e retorne o primeiro número elevado à potência do segundo. Por exemplo: minhaFuncao(5,2) = 5² = 25.</p>
            </article>

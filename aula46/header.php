        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="exercicio-3-2.php"><i class="fas fa-code"></i> Exercício 3.2.</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://github.com/Marcelo-Diament/dh-entregaveis/tree/master/aula46" target="_blank" alt="Acessar repositório da aula 46" title="Acessar repositório da aula 46" rel="help"><i class="fab fa-github" style="color:#8acf17;"></i> Repositório</a>
            </li>
            </ul>
        </div>
    </nav>

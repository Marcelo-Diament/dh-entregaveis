    ...
    <main class="container">
        <section class="row">
            <article class="enunciado col-12">
                <h2 class="title"><i class="fas fa-terminal"></i> <b>Exercício 3.5.</b></h2>
            ...
            <article class="resposta col-12">
                ...
                <pre>
pessoa.cumprimento()<span class="terminal">_</span>
                </pre>
                <small>Resultado ocorreu corretamente (printou "<i>Olá Kawara Nofuro!</i> ").</small>
            </article>
        </section>
    </main>
